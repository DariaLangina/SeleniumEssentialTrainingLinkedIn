package dlangina.advancedSeleniumSupportClasses.from_03_02;
...
public class CustomLocatorsTest {
    ...
    public void attributeFindBy() {
        ...
        WebElement instructions = driver.findElement(new ByAttributeValue("data-locator",
                "instructions")); // ex: (By.cssSelector("[data-locator='instructions']")
    ...
    public void dataLocatorFindBy() {
        ...
        WebElement title = driver.findElement(
                new ByGlobalDataAttribute("title", "historytitle")); //ex: (By.cssSelector("[data-title='historytitle']"))
